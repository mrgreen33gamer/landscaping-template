...
// GreenScape Pro — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Lawn Mowing & Maintenance', 'Landscape Design', 'Irrigation & Sprinkler Systems',
  'Hardscaping', 'Tree & Shrub Care', 'Seasonal Cleanup',
  'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 900-5200. We answer 7 days a week including evenings. For a time-sensitive issue like an irrigation leak, call — don't wait on a form response.",
  },
  {
    question: 'How quickly can someone come out?',
    answer: "Most new-customer visits are scheduled within the week. Irrigation leaks and other time-sensitive issues are usually seen sooner. We'll give you an honest timeline when you call — not a vague window.",
  },
  {
    question: 'Do you charge for the on-site estimate?',
    answer: 'No — the initial walkthrough and written quote are free. You\'ll know the flat-rate price before any work begins.',
  },
  {
    question: 'Do you work on commercial and HOA properties?',
    answer: 'Yes — light commercial landscaping for restaurants, offices, retail spaces, and HOA common areas is within our scope. Call to discuss your property and schedule.',
  },
  {
  ...
  {
    question: 'How do I know if I need a repair or a full irrigation system replacement?',
    answer: "Our tech will tell you honestly after the diagnosis. If repair costs start approaching what a new zone or controller would cost, we'll recommend replacement — but we'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@greenscapeprowaco.com',
                  href:      'mailto:hello@greenscapeprowaco.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '3311 Franklin Ave, Waco TX 76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why property owners choose GreenScape Pro</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '30-Day Re-Service Guarantee on every job',
                'TDA-licensed crews only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A GreenScape Pro team member will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549005200">(254) 900-5200</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 900-5200 — we answer 7 days a week, evenings included. Serving all of Central Texas."
        primaryText="Call (254) 900-5200"
        primaryLink="tel:+12549005200"
        secondaryText="Send a Text"
        secondaryLink="sms:+12549005200"
      />
