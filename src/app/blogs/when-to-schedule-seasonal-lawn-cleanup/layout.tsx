...
const slug     = 'when-to-schedule-seasonal-lawn-cleanup';
const post     = getPostBySlug(slug)!;
const url      = `${BASE_URL}/blogs/${slug}`;
const imgUrl   = `${BASE_URL}/pages/blogs/seasonal-cleanup-timing.svg`;

export const metadata: Metadata = {
  title: `${post.title} | Scott Applications`,
  description: post.excerpt,
  keywords: ['seasonal lawn cleanup waco', 'fall cleanup central texas', 'spring cleanup timing texas', 'when to schedule yard cleanup'],
...
const articleSchema = {
  ...
  keywords: 'seasonal lawn cleanup waco, fall cleanup central texas',
  articleSection: 'Seasonal Care',
  inLanguage: 'en-US',
};
