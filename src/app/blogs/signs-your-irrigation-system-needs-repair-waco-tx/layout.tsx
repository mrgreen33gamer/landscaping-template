...
const slug     = 'signs-your-irrigation-system-needs-repair-waco-tx';
const post     = getPostBySlug(slug)!;
const url      = `${BASE_URL}/blogs/${slug}`;
const imgUrl   = `${BASE_URL}/pages/blogs/irrigation-repair-signs.svg`;

export const metadata: Metadata = {
  title: `${post.title} | Scott Applications`,
  description: post.excerpt,
  keywords: ['irrigation repair waco tx', 'sprinkler system signs of damage', 'irrigation system repair central texas', 'sprinkler repair waco'],
  ...
  openGraph: {
    ...
    images: [{ url: imgUrl, width: 1200, height: 675, alt: post.imageAlt }],
  },
  twitter: {
...
const articleSchema = {
  ...
  keywords: 'irrigation repair waco tx, sprinkler system signs of damage',
  articleSection: 'Irrigation',
  inLanguage: 'en-US',
};
