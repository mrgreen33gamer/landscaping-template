    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>GreenScape Pro - Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas property owners — lawn care, landscape design, irrigation, and more.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need reliable lawn care in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We've been keeping Waco-area homes and businesses looking their best with expert lawn care, landscaping, and irrigation service since 2012. Free estimate, no obligations.
            </p>
