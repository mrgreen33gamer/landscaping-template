...
export default function NewsletterSignup({
  ...
  const defaultBody1  = 'Get fresh Central Texas lawn care tips, seasonal timing reminders, and local updates — delivered straight to your inbox. No fluff, no spam.';
  const defaultTag1   = 'Blog Updates';

  const defaultTitle2 = 'Don\'t miss the next one.';
  const defaultBody2  = 'Join other Central Texas property owners getting practical lawn care and landscaping tips every month.';
