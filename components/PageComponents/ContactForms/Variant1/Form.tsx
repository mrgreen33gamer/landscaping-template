...
import {
  ...
  faLeaf, faDraftingCompass, faDroplet, faHammer, faTree, faBroom,
...
const SERVICES = [
  { icon: faLeaf,            label: 'Lawn Mowing & Maintenance' },
  { icon: faDraftingCompass, label: 'Landscape Design' },
  { icon: faDroplet,         label: 'Irrigation & Sprinkler Systems' },
  { icon: faHammer,          label: 'Hardscaping' },
  { icon: faTree,            label: 'Tree & Shrub Care' },
  { icon: faBroom,           label: 'Seasonal Cleanup' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'TDA Licensed' },
  { icon: faStar,         text: '4.9★ · 250+ reviews' },
];
      ...
      <div className={styles.inner}>
        ...
        <motion.div className={styles.header}
          ...
          <p className={styles.subtitle}>
            Tell us what you need and we'll have a GreenScape Pro team member reach out — <strong>flat-rate quote, no pressure</strong>.
          </p>
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A GreenScape Pro team member will reach out shortly. Keep an eye on your inbox and phone.
                </p>
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.35 }}>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  <div className={styles.fieldsSection}>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v1r-message">Tell Us About Your Project</label>
                      <textarea id="v1r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" placeholder="What do you need done? Any specifics we should know?" rows={2}
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12549005200"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 900-5200', section: 'ContactForm-V1' })}>
                          Call (254) 900-5200
                        </a>
                      </span>
                    </div>
