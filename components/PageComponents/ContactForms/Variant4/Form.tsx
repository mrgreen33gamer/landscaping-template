...
const SERVICES = [
  { icon: faLeaf,             label: 'Lawn Mowing & Maintenance',    sub: 'Regular mowing, edging, and upkeep' },
  { icon: faDraftingCompass,  label: 'Landscape Design',             sub: 'New beds, plantings, full redesigns' },
  { icon: faDroplet,          label: 'Irrigation & Sprinkler Systems', sub: 'Install, repair, or diagnose a system' },
  { icon: faHammer,           label: 'Hardscaping',                  sub: 'Patios, walkways, retaining walls' },
  { icon: faTree,             label: 'Tree & Shrub Care',            sub: 'Pruning, removal, health assessments' },
  { icon: faBroom,            label: 'Seasonal Cleanup',             sub: 'Fall or spring debris and bed cleanup' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A GreenScape Pro team member will reach out about your <strong>{selectedService}</strong> service.
                  </p>
                ...
                <motion.div key="step2" custom={dir} variants={slideVariants}
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v4r-message">Tell Us About Your Project</label>
                      <textarea id="v4r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" rows={3}
                        placeholder={`Tell us more about your ${selectedService.toLowerCase()} needs.`}
