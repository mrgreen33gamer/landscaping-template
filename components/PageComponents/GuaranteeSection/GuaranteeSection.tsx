...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every visit is covered for 30 days. If anything about the work isn't right, we come back and fix it at no charge.",
  },
  {
    icon: faRotateLeft,
  ...
  {
    icon: faCertificate,
    title: "TDA-Licensed Crews",
    description:
      "Every crew lead works under our TDA-licensed applicator status. No apprentices working alone — ever.",
  },
  {
    icon: faCalendarCheck,
    title: "No Contracts. No Lock-In.",
    description:
      "Our service plans are month-to-month. We earn your business with every visit — not by holding you hostage with a contract.",
  },
  {
    icon: faStar,
...
const GuaranteeSection: React.FC<GuaranteeSectionProps> = ({
  ...
  body       = "Every landscaping company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, licensed crews, and a 30-day guarantee on every visit.",
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 250+ verified Google reviews</span>
          </div>
        </div>
