...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Lawn Care Tips & Insights',
  subtitle    = 'Practical advice for Central Texas property owners — seasonal timing, water savings, and what to watch for around your yard.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
