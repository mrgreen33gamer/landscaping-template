      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h2 className={styles.title}>
            Done in <span className={styles.accent}>4 Simple Steps</span>
          </h2>
          <p className={styles.sub}>
            No runaround. No hidden charges. Just reliable, professional landscaping service from call to completion.
          </p>
        </motion.div>
