...
// FIX (task 12): removed hardcoded "digital problems" framing (leftover from a web-design-agency
// template) — header copy is now industry-agnostic so it fits non-digital-services verticals too.
"use client";
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subline}>
            These aren&apos;t abstract problems — they&apos;re costing real time, real trust, and real budget every week.
          </p>
        </div>
